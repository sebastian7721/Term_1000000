...
class GuessingGame2(cmd.Command):
    min_int: int
    max_int: int

    def __init__(self):
        super().__init__(name="guessingGame2", description="runs a guessing game", capitalName="Guessing Game", version=0.1)
    ...
    def run(self, argv):
        ...
        print(f"You did it in {eclapsedTime} seconds.")
